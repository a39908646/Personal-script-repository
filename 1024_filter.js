...
; (() => {
    ...
    function injectStyles() {
        ...
        .filter-panel h4 { margin: 8px 0 4px 0; font-size: 12px; font-weight: 600; color: #555; padding-bottom: 4px; }
        ...
        .kw { display: flex; justify-content: space-between; align-items: center; border-radius: 6px; padding: 4px 8px; font-size: 12px; user-select: none; transition: background 0.2s; }
